...
const requiredFiles = ['README.md', 'REPO-MAP.md', 'DUAL-END.md', 'PORTABILITY.md', 'SECURITY.md', 'package.json', 'package-lock.json', 'requirements.txt', 'opencode.example.jsonc']
